            ...
            if self.decision == 3:  # O(n)
                ...
                if self.decision == 1:  # O(n)
                    ...
                    if self.decision == 2:  # O(n)
                        ...
                        if self.decision == 2:  # O(n)
                            print("\033[97;1m" + "\nVariations ordinary" + "\033[0m")  # O(n)
                            operation = Variations()  # O(n)
                            print("\033[92;1m" + str(operation.ordinary_operation()) + "\033[0m")  # O(n)
                        else:  # O(n)
                            print("\033[97;1m" + "\nVariations with repetitions" + "\033[0m")  # O(n)
                            operation = Variations()  # O(n)
                            print("\033[92;1m" + str(operation.variation_operation()) + "\033[0m")  # O(n)
                    else:  # O(n)
                        self.decision = int(
                            input("\033[91;1m" + 
                                "\n\t\t\t¿¿Se repiten los elementos? \n\t\t\t(1) Si \n\t\t\t(2) No \n\t\t\topción: " + "\033[0m"
                        ...
                        if self.decision == 2:  # O(n)
                            print("\033[97;1m" + "\nPermutations ordinary" + "\033[0m")  # O(n)
                            operation = Permutation()  # O(n)
                            print("\033[92;1m" + str(operation.ordinary_operation()) + "\033[0m")  # O(n)
                        else:  # O(n)
                            print("\033[97;1m" + "\nPermutations with repetitions" + "\033[0m")  # O(n)
                            operation = Permutation()  # O(n)
                            print("\033[92;1m" + str(operation.variation_operation()) + "\033[0m")  # O(n)
                else:  # O(n)
                    self.decision = int(
                    ...
                    if self.decision == 2:  # O(n)
                        print("\033[97;1m" + "\nCombinations ordinary" + "\033[0m")  # O(n)
                        operation = Combination()  # O(n)
                        print("\033[92;1m" + str(operation.ordinary_operation()) + "\033[0m")  # O(n)
                    else:  # O(n)
                        print("\033[97;1m" + "\nCombinations with repetitions" + "\033[0m")  # O(n)
                        operation = Combination()  # O(n)
                        print("\033[92;1m" + operation.variation_operation() + "\033[0m")  # O(n)
            elif self.decision == 1:  # O(n)
                operation = PrinciplesCounting()  # O(n)
                print("\033[97;1m" + "\nPrinciples of counting" + "\033[0m") # O(n)
                print("\033[92;1m" + str(operation.list_multiplier()) + "\033[0m")  # O(n)
